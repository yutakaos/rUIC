...
#'   UIC is the unified theory of convergent cross mapping (CCM) and transfer
#'   entropy (TE). The functions of this package have similar interface to
#'   \pkg{rEDM} because the UIC algorithm was developed based on that of CCM.
#' @details
...
#'     \item \code{\link{uic}    } - unified infomation-theoretic causality
#'   }
#' @keywords package
NULL
